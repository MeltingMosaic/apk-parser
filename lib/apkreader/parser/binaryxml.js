  ...
  (function () {
    ...
    BinaryXmlParser = (function () {
      ...
      BinaryXmlParser.prototype.readU8 = function () {
        var val;
        val = this.buffer.getUint8(this.cursor);
        this.cursor += 1;
        return val;
      };
      ...
      BinaryXmlParser.prototype.readU16 = function () {
        var val;
        val = this.buffer.getUint16(this.cursor, true);
        this.cursor += 2;
        return val;
      };
      ...
      BinaryXmlParser.prototype.readS32 = function () {
        var val;
        val = this.buffer.getInt32(this.cursor, true);
        this.cursor += 4;
        return val;
      };
      ...
      BinaryXmlParser.prototype.readU32 = function () {
        var val;
        val = this.buffer.getUint32(this.cursor, true);
        this.cursor += 4;
        return val;
      };
      ...
      BinaryXmlParser.prototype.readString = function (encoding) {
        ...
        switch (encoding) {
          case 'utf-8':
            ...
            var buf = this.buffer.buffer.slice(this.cursor, this.cursor += byteLength);
            value = new TextDecoder('utf-8').decode(buf);
            this.readU16();
            return value;
          case 'ucs2':
            ...
            var buf = this.buffer.buffer.slice(this.cursor, this.cursor += byteLength);
            value = String.fromCharCode.apply(null, new Uint16Array(buf));
            this.readU16();
            return value;
          default:
